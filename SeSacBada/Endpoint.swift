...
enum Endpoint {
    ...
    case changePW
    case readPost
    case readSinglePost(postId: Int)
...
extension Endpoint {
    var url: URL {
        ...
        case .readPost: return .makeEndPoint("posts?_sort=created_at%3Adesc")
        case .readSinglePost(postId: let id): return .makeEndPoint("posts/\(id)")
        ...
        case .editComment(commentId: let id): return .makeEndPoint("comments/\(id)")
        case .deleteComment(commentId: let id): return .makeEndPoint("comments/\(id)")
